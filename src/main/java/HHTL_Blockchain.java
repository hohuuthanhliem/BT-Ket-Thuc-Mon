...
public class HHTL_Blockchain {

    public static ArrayList<VNPT_Liem> blockchain = new ArrayList<VNPT_Liem>();
    ...
    public static void main(String[] args) {
        ...
        VNPT_Liem genesis = new VNPT_Liem("0");
        genesis.addTransaction(genesisTransaction);
        addBlock(genesis);

        //Thử nghiệm
        VNPT_Liem block1 = new VNPT_Liem(genesis.hash);
    ...
    public static Boolean isChainValid() {
        VNPT_Liem currentBlock;
        VNPT_Liem previousBlock;
    ...
    public static void addBlock(VNPT_Liem newBlock) {
